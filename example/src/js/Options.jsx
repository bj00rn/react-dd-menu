...
export default [
  ...
  {
    text: 'Max height, enforce max height apply vertical scroll',
    maxHeight: 200,
    additionalItems: [
      <li key="sep1" role="separator" />,
      <li key="woop"><a href="#">Woop Woop</a></li>,
      ...
      <li key="sep3" role="separator" className="separator" />,
      <li key="some"><a href="#">Something</a></li>,
      <li key="sep4" role="separator" />,
      <li key="woop1"><a href="#">Woop Woop</a></li>,
      <li key="sep5" className="separator" />,
      <li key="fred1"><a href="#">Fred Flinstone</a></li>,
      <li key="guac1"><a href="#">Guacamole</a></li>,
      <li key="sep6" role="separator" className="separator" />,
      <li key="some1"><a href="#">Something</a></li>,
      <li key="sep7" role="separator" />,
      <li key="woop2"><a href="#">Woop Woop</a></li>,
    ],
  },
];
